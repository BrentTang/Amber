...
/**
 * @author 豪
 * @title: AmberConnection
 * @projectName Java
 * @description: 暂未使用
 * @date 2019/6/29 14:19
 */
public class AmberConnection implements Connection {
    ...
    public AmberConnection(Connection connection, AmberPool pool) {
